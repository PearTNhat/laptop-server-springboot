...
public class OrderImpl implements OrderService {
    ...
    public MoMoResponse createOrder(OrderRequest request) {
        ...
        String rawSignature = "accessKey=" + accessKey + "&amount=" + total + "&extraData=" + extraData + "&ipnUrl="
    ...
    public String createExtraData(List<OrderProductRequest> products, Long total, String address, String phone,
